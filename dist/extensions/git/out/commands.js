...
class CommandCenter {
    ...
    async openChanges(repository) {
        [
            ...
            vscode_1.commands.executeCommand('vscode.open', resource.resourceUri, { preview: false, });
        });
    }
    ...
    async _push(repository, pushOptions) {
        ...
        if (pushOptions.forcePush) {
            ...
            forcePushMode = config.get('useForcePushWithLease') === true ? 1 /* ForceWithLease */ : 0 /* Force */;
