...
suite('Tests for Wrap with Abbreviations', () => {
	...
	`;
        return testWrapWithAbbreviation([new vscode_1.Selection(1, 1, 1, 1)], 'a[href="https://example.com"]>div', expectedContents, contents);
    });
...
`;
        return testWrapWithAbbreviation([new vscode_1.Selection(2, 2, 3, 33)], '.hello', wrapMultiLineJsxExpected, htmlContentsForBlockWrapTests, 'jsx');
    });
...
`;
        return testWrapIndividualLinesWithAbbreviation([new vscode_1.Selection(2, 2, 3, 33)], '.hello$*', wrapIndividualLinesJsxExpected, htmlContentsForBlockWrapTests, 'jsx');
    });
});
function testWrapWithAbbreviation(selections, abbreviation, expectedContents, input, fileExtension = 'html') {
...
function testWrapIndividualLinesWithAbbreviation(selections, abbreviation, expectedContents, input, fileExtension = 'html') {
    return testUtils_1.withRandomFileEditor(input, fileExtension, (editor, _) => {
        editor.selections = selections;
