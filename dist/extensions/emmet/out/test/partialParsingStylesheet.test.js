...
suite('Tests for partial parse of Stylesheets', () => {
    function isValid(doc, range, syntax) {
        ...
        const currentNode = util_1.getFlatNode(rootNode, endOffset, true);
        return abbreviationActions_1.isValidLocationForEmmetAbbreviation(doc, rootNode, currentNode, syntax, endOffset, range);
    }
