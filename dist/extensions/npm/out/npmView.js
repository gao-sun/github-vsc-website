...
class NpmScriptsTreeDataProvider {
    ...
    async runScript(script) {
        ...
        await tasks_1.getPackageManager(this.context, script.getFolder().uri);
    ...
    async runInstall(selection) {
        ...
        let task = await tasks_1.createTask(this.extensionContext, 'install', ['install'], selection.folder.workspaceFolder, uri, true, undefined, []);
