...
exports.createRandomFile = exports.testFs = exports.rndName = exports.TestFS = void 0;
...
exports.testFs = new TestFS('fake-fs', true);
...
async function createRandomFile(contents = '', dir = undefined, prefix = '', ext = '') {
    let fakeFile;
    if (dir) {
        fakeFile = dir.with({ path: dir.path + '/' + rndName() + ext });
    }
    else {
        fakeFile = vscode.Uri.parse(`${exports.testFs.scheme}:/${prefix}-${rndName() + ext}`);
    }
